...
<body>
	<div class="jumbotron">
		...
		$query = "update DigitalDisplay set modelNo='$update' where serialNo='$original';";
		$result = $conn->query($query) or die(mysqli_error($conn));
		$query = "update DigitalDisplay set schedulerSystem='$sched' where serialNo='$original';";
		$result = $conn->query($query) or die(mysqli_error($conn));
		$query = "update DigitalDisplay set serialNo='$ser' where serialNo='$original';";
		$result = $conn->query($query) or die(mysqli_error($conn));
